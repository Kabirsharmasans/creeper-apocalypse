...
public class ChallengeData {
    ...
    public void setCurrentDay(int day) {
        ...
        if (this.currentDay > highestDayReached) {
            highestDayReached = this.currentDay;
        }
    ...
    public void setHighestDayReached(int day) { this.highestDayReached = Math.max(currentDay, day); }
    ...
    public void setSpawnMultiplier(float multiplier) {
        ...
        this.spawnMultiplier = Math.max(0.0f, multiplier);
    }
    ...
    /**
     * Recomputes spawn multiplier using the current config and current day.
     */
    public void refreshSpawnMultiplier() {
        updateSpawnMultiplier();
    }
    ...
    public static ChallengeData load(MinecraftServer server) {
        ...
        if (Files.exists(dataPath)) {
            try {
                ...
                if (data == null) {
                    CreeperApocalypse.LOGGER.warn("Challenge data file was null JSON; using defaults");
                ...
                if (data.highestDayReached < data.currentDay) {
                    data.highestDayReached = data.currentDay;
                }
